...
export class Tree {
    ...
    items = $derived(extract(this.#props.items));
    ...
    #clearTypeahead = $derived(useDebounce(() => {
    ...
    typeahead(letter) {
        ...
        if (!elementsForTypeahead.length)
            return;
        ...
        const nextEl = elementsForTypeahead.find((e) => {
     ...
     */
    get children() {
        return this.items.map((i) => new Child({ tree: this, item: i, parent: this, selectedState: this.#selected }));
    }
}
/**
