...
export declare class Tree<I extends TreeItem[], Multiple extends boolean = false> {
     ...
     */
    get selected(): FalseIfUndefined<Multiple> extends infer T ? T extends FalseIfUndefined<Multiple> ? T extends true ? import("svelte/reactivity").SvelteSet<string> : string | undefined : never : never;
    set selected(v: FalseIfUndefined<Multiple> extends infer T ? T extends FalseIfUndefined<Multiple> ? T extends true ? import("svelte/reactivity").SvelteSet<string> : string | undefined : never : never);
    /**
...
declare class Child<I extends TreeItem[]> {
    ...
    get previousSibling(): Child<I>;
    /** Gets the next sibling item */
    get nextSibling(): Child<I>;
