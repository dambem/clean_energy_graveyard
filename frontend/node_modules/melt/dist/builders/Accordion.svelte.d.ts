...
export declare class Accordion<Multiple extends boolean = false> {
    ...
    get value(): FalseIfUndefined<Multiple> extends infer T ? T extends FalseIfUndefined<Multiple> ? T extends true ? import("svelte/reactivity").SvelteSet<string> : string | undefined : never : never;
    set value(value: FalseIfUndefined<Multiple> extends infer T ? T extends FalseIfUndefined<Multiple> ? T extends true ? import("svelte/reactivity").SvelteSet<string> : string | undefined : never : never);
    /**
