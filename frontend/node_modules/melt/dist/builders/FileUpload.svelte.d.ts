...
import { type MaybeMultiple } from "../utils/selection-state.svelte";
...
export declare class FileUpload<Multiple extends boolean = false> {
     ...
     */
    get selected(): Multiple extends true ? import("svelte/reactivity").SvelteSet<File> : File | undefined;
    /**
     * Sets the currently selected files
     */
    set selected(value: Multiple extends true ? import("svelte/reactivity").SvelteSet<File> : File | undefined);
    /**
