 ...
 */
type SelectionStateValue<T, Multiple extends _multiple_extends> = Multiple extends true ? SvelteSet<T> : T | undefined;
/**
 * Represents a value or getter for selection state
 * @template T - The type of values that can be selected
 * @template Multiple - Boolean flag indicating if multiple selection is enabled
 */
export type MaybeMultiple<T, Multiple extends _multiple_extends> = Multiple extends true ? SvelteSet<T> | MaybeGetter<Iterable<T> | undefined> : MaybeGetter<T | undefined>;
/**
